...
const snippetAnswer =
  'Etihad is the only UAE airline that takes small dogs and cats in the cabin. Pet plus carrier must be 8 kg or less and land at Abu Dhabi. Cabin fee from USD 399 in Economy (source: Etihad). Confirm the live amount on Etihad’s travelling-with-pets page before you pay.'

const faqData = [
  {
    q: 'How much does it cost to bring a cat in the cabin on an Etihad flight?',
    a: 'From USD 399 per flight in Economy (source: Etihad). In Business you must buy an extra seat plus USD 399. Confirm the live amount on Etihad’s travelling-with-pets page before you pay. We are not Etihad and we do not sell airline tickets.',
  },
  {
    q: 'Etihad pet in cabin business class',
    a: 'Etihad’s published Business cabin-pet path is an extra seat plus USD 399 (source: Etihad). Extra-seat carrier size is published at 50 × 43 × 50 cm. Confirm the live combination at booking. We coordinate eligibility and AUH arrival; we do not sell the seat.',
  },
  {
...
export default function EtihadPetPolicyGuide() {
  ...
  const description =
    'Etihad pets in cabin: the only UAE dog-and-cat cabin product. From USD 399 in Economy (source: Etihad); confirm live at booking. ≤8 kg including carrier, AUH arrival and Dubai transfer.'
  ...
  return (
    <div>
      ...
      <Hero
        ...
        subtitle="Small dogs and cats, booked early — arriving at Abu Dhabi, not Dubai International. From USD 399 in Economy (source: Etihad); confirm live at booking. We coordinate the file; Etihad operates the flight."
      ...
      <section className="section-padding bg-[#F5F6FD]">
        <div className="mx-auto max-w-[900px] px-5 sm:px-6 lg:px-8">
          ...
          <p className="mb-4 text-sm leading-relaxed text-[#5A5A5A]">
            ...
            page. Cabin fee from USD 399 in Economy (source: Etihad) — confirm the live amount at booking. We are not affiliated with Etihad.
          </p>
          ...
          <div className="mb-6 overflow-x-auto">
            <table className="w-full min-w-[560px] border-collapse text-sm">
              ...
              <tbody>
                {[
                  ['Cabin pet fee', 'From USD 399 in Economy (source: Etihad). Confirm live at booking.'],
                  ['Business cabin pet fee', 'Extra seat plus USD 399 (source: Etihad). Confirm live at booking.'],
