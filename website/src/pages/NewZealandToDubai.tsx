...
export default function NewZealandToDubai() {
  ...
  return (
    <div className="bg-[#F5F6FD]">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-[#F5F6FD] rounded-[20px] p-6 lg:p-8">
              ...
              <ul className="space-y-4 text-[#5A5A5A] text-sm leading-relaxed">
                ...
                <li className="flex items-start gap-3">
                  <Info className="w-5 h-5 text-[#4F5BD5] shrink-0 mt-0.5" />
                  <span>No titer test is required for New Zealand pets. That removes a lab step and months of titer timing compared with high-risk routes — we do not publish a package saving figure here.</span>
                </li>
              </ul>
      ...
      <RouteCostTeaser
        corridor="New Zealand to Dubai"
        whatsappMessage="Hi Dubai Pet Relocation! I need a quote for relocating my pet from New Zealand to Dubai."
      />
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link to="/routes/dubai-to-new-zealand/" className="block bg-[#F5F6FD] rounded-[20px] p-6 hover:shadow-sm transition-shadow">
              <p className="font-bold text-[#2A2A2A] mb-1">Exporting from Dubai to New Zealand</p>
              <p className="text-[#5A5A5A] text-sm">The outbound twin — MPI import rules, not this inbound file.</p>
            </Link>
          </div>
        </div>
      </section>
