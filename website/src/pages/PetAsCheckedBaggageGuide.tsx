...
export default function PetAsCheckedBaggageGuide() {
  ...
  return (
    <div>
      ...
      <section className="section-padding bg-white">
        <div className="mx-auto max-w-[900px] px-5 sm:px-6 lg:px-8">
          <h2 className="mb-4 text-[24px] font-bold text-[#2A2A2A] sm:text-[30px]">Fees sit on the cargo guide. This page is about eligibility.</h2>
          <p className="mb-4 leading-relaxed text-[#5A5A5A]">
            This guide covers pets as checked baggage in the UAE: accompanied hold, excess / AVIH, the Emirates under-17-hour outbound rule, and the DXB-ending cargo disclaimer. The full Emirates USD 500 / 650 / 800 animal-charge table lives on the{' '}
            <Link to={FLIGHT_MODE_PATHS.cargo} className="font-semibold text-[#4F5BD5] hover:underline">
