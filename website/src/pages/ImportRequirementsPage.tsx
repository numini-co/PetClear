        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white rounded-[20px] shadow-sm p-6 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
              ...
              <ul className="text-sm text-[#5A5A5A] space-y-1">
                <li><strong>In-cabin (to Abu Dhabi only):</strong> Small dogs and cats allowed. Pet + carrier must weigh ≤8 kg. Carrier max: 40 x 40 x 22 cm. Etihad cabin fee from USD 399 in Economy (source: Etihad). Confirm the live amount at booking.</li>
