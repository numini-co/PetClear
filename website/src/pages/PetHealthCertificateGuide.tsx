            ...
            <div className="bg-white rounded-[20px] shadow-sm p-6 lg:p-8">
              ...
              <ol className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-[#5A5A5A] mt-0.5"><strong className="text-[#2A2A2A]">MOCCAE import permit</strong> — valid 90 days from issuance; confirm the current portal fee</span>
                </li>
                <li className="flex items-start gap-3">
