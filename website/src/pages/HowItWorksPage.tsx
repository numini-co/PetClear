          ...
          <div className="overflow-x-auto rounded-2xl shadow-sm border border-gray-100 mb-8">
            <table className="data-table">
              ...
              <tbody>
                ...
                <tr><td>Etihad cabin — airline fee</td><td>From USD 399 Economy (source: Etihad); Business extra seat + USD 399. Confirm live.</td><td>You, to the airline</td><td>Not a current standard fee and not a DPR package. Emirates / flydubai / Air Arabia cabin N/A for cats and dogs (falcons excepted).</td></tr>
