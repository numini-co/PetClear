          ...
          <div className="overflow-x-auto rounded-2xl shadow-sm border border-gray-100 mb-8">
            <table className="data-table">
              ...
              <tbody>
                ...
                <tr><td>Etihad cabin — airline fee</td><td>Fees change; confirm at booking. 2026 from-USD-399 promo expired. USD 1,500 = Estimated only</td><td>You, to the airline</td><td>Not a current standard fee and not a DPR package. Emirates / flydubai / Air Arabia cabin N/A for cats and dogs (falcons excepted).</td></tr>
                ...
                <tr><td>Shared charter seat</td><td>Get a Quote</td><td>You</td><td>No published charter prices on this site.</td></tr>
