        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 max-w-3xl">
            ...
            <Step number={3} title="MOCCAE Import Permit (Days 14–21)">
              <p>We apply for your cat's MOCCAE import permit online. This is a mandatory approval from the UAE Ministry of Climate Change and Environment. The permit is valid for 90 days from issuance. Confirm the current import-permit fee and the arrival-release fee on the official MOCCAE portal — fees may change. We handle the submission, track the status, and confirm approval — so you don't have to navigate the portal yourself.</p>
            </Step>
