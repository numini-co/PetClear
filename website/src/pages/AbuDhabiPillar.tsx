...
export default function AbuDhabiPillar() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Costs depend on origin country, pet size, airline and route rather than the emirate itself. The total covers veterinary preparation, the MOCCAE import permit and arrival-release fee (confirm live portal amounts; fees may change), the IATA-compliant travel crate, air freight, customs clearance at the airport, municipality registration and ground transport to your home. Because the import requirements are nationwide, the government fees are the same as for Dubai. We provide a detailed, itemised quote for your specific route before you commit anything.',
    },
    {
