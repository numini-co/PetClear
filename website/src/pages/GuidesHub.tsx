...
const GUIDES = [
  ...
  { title: 'Pet Import Documents Checklist', to: '/guides/import-checklist/', image: '/images/import-hero.jpg', desc: 'Ordered tick-list: microchip, vaccines, titer window, 90-day MOCCAE permit, crate and cargo clearance.' },
