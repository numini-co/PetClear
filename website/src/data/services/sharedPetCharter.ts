...
const sharedPetCharter: ServicePageData = {
  ...
  metaDescription:
    'Offer page for shared / group pet charter — a dedicated lift shared with other pets, between scheduled cargo and a full private jet. Quote only — we do not publish charter prices.',
  keywords:
  ...
  snippetAnswer:
    'A shared pet charter is a dedicated lift that several pets share — more control than scheduled cargo, without buying a whole private jet. A firm seat we coordinate is Get a Quote. We do not publish charter prices. Documents and the 30-day import permit still apply.',
  trustBadges: ['Firm seat = Get a Quote', 'No published charter prices', 'Documents still required', 'WhatsApp during business hours'],
  hasHowTo: true,
      ...
      body: [
        {
          ...
          steps: [
            ...
            {
              title: 'Quote',
              text: 'A WhatsApp Get a Quote for our coordination plus the operator’s per-pet lift charge when we have it. We do not print a charter rate card on this page.',
            },
            {
