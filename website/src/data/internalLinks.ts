...
export const LINK_EDGES: LinkEdge[] = [
  ...
  edge('/', '/service/pet-relocation-dubai/', 'Homepage overview', 'money', 'hub', 2, 'Category entry — not the money-head service page'),
  edge('/guides/', '/', 'Homepage overview', 'money', 'hub', 2, 'Category entry — not the money-head service page'),
  edge('/guides/', '/services/', 'Compare our service tiers', 'money', 'hub', 2, 'How much of the file we hold'),
  edge('/guides/', '/service/pet-relocation-dubai/', 'Our Dubai pet relocation service', 'money', 'hub', 1, 'Door-to-door money page after you have read the rule'),
  ...
  edge('/routes/', '/', 'Homepage overview', 'money', 'hub', 2, 'Category entry for pet relocation coordination in Dubai'),
  ...
  edge('/cities/', '/', 'Homepage overview', 'money', 'hub', 2, 'Category entry for UAE pet relocation coordination'),
  edge('/cities/', '/services/', 'Compare our service tiers', 'money', 'hub', 2, 'Essential through full coordination'),
  edge('/cities/', '/service/pet-relocation-dubai/', 'Door-to-door pet relocation in Dubai', 'money', 'hub', 1, 'Money-head service after you pick the emirate'),
  ...
  edge('/dubai/', '/service/pet-relocation-dubai/', 'Door-to-door pet relocation in Dubai', 'money', 'hub', 1, 'Money-head international file — not this directory'),
  ...
  edge('/guides/iata-pet-crate-requirements/', '/service/dog-relocation-dubai/', 'Dog relocation service', 'species-dog', 'related', 1, 'Species money page for crate-led dog files'),
  ...
  edge('/cities/dubai/', '/service/pet-relocation-dubai/', 'Door-to-door pet relocation in Dubai', 'money', 'related', 1, 'Money-head file after the emirate overview'),
  ...
  edge('/prices/', '/service/pet-relocation-dubai/', 'Pet relocation Dubai', 'money', 'related', 1, 'Door-to-door money page'),
