...
export const LINK_EDGES: LinkEdge[] = [
  ...
  edge('/', '/service/pet-relocation-dubai/', 'Homepage overview', 'money', 'hub', 2, 'Homepage — not the door-to-door service page'),
  edge('/guides/', '/', 'Homepage overview', 'money', 'hub', 2, 'Homepage — not the door-to-door service page'),
  edge('/guides/', '/services/', 'Compare our service tiers', 'money', 'hub', 2, 'How much of the file we hold'),
  edge('/guides/', '/service/pet-relocation-dubai/', 'Our Dubai pet relocation service', 'money', 'hub', 1, 'Door-to-door service page after you have read the rule'),
  ...
  edge('/routes/', '/', 'Homepage overview', 'money', 'hub', 2, 'Homepage for pet relocation coordination in Dubai'),
  ...
  edge('/cities/', '/', 'Homepage overview', 'money', 'hub', 2, 'Homepage for UAE pet relocation coordination'),
  edge('/cities/', '/services/', 'Compare our service tiers', 'money', 'hub', 2, 'Essential through full coordination'),
  edge('/cities/', '/service/pet-relocation-dubai/', 'Door-to-door pet relocation in Dubai', 'money', 'hub', 1, 'Door-to-door service after you pick the emirate'),
  ...
  edge('/dubai/', '/service/pet-relocation-dubai/', 'Door-to-door pet relocation in Dubai', 'money', 'hub', 1, 'Door-to-door international file — not this directory'),
