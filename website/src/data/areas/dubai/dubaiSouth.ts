...
const dubaiSouth: AreaPageData = {
  ...
  faq: [
    ...
    { q: 'How long does pet relocation from Dubai South take?', a: 'From low-risk countries, usually 2–6 weeks. From high-risk rabies countries that need a titer test, plan the titer sample within 90 days before travel (result ≥0.5 IU/ml) — a sample window, not a wait after the draw.' },
