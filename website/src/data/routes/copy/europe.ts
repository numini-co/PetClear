...
export const EUROPE_COPY: RouteUniqueCopy[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          '90 days from the date of issuance. The pet must enter the UAE inside that window. The official window is 90 days from issuance — do not confuse it with the titer sample clock, and do not treat a French EU passport as a substitute for the permit.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'No. An EU pet passport helps identification and vaccine history, but UAE entry is a MOCCAE import-permit file plus origin health papers that match the microchip. The passport does not replace the 90-day permit or cargo acceptance.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          '90 days from issuance. The pet must enter the UAE inside that window. A delayed IST cargo slot after issuance is a classic way to burn the permit.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Plan destination-backwards: confirm the current ministry entry process first, including any advance permission, then time the MOCCAE export certificate to those dates. We do not assume a form name or a fee.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          '90 days from issuance. The pet must enter the UAE inside that window. A slipped MAD cargo date after issuance is a common way to burn the permit.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          '90 days from issuance. The pet must enter the UAE inside that window. Waiting for a preferred KLM bank after issuance is a common way to burn the permit.',
      },
      {
  ...
  },
  {
    ...
    airportsNarrative:
      'The Netherlands arrival seed list is one code: Amsterdam Schiphol (AMS). That is the import gateway conversation. Schiphol can handle live animals, but airport presence is not automatic acceptance — the booking must be a pet product and the EU certificate must name this point of entry. Do not assume Rotterdam The Hague, Eindhoven, or Maastricht as pet-import airports on this corridor. Compact Dutch geography means most families can collect from AMS and continue by road; that convenience is not a second airport. UAE departure toward Amsterdam: a DXB passenger ticket often still ships the animal as cargo or hold depending on the KLM or Gulf product. DWC leaving for Spain is a SkyCargo-style origin, not an El Prat passenger convenience. Abu Dhabi (AUH) is the Etihad alternate — confirm the outbound pet product, which can differ from whatever you used inbound. Write AMS on the EU certificate, the airway bill, and the UAE export file. Leaving the UAE, DXB passenger tickets still often move the animal as cargo; DWC is the SkyCargo-style alternative; AUH is the Etihad alternate when that routing is real. Schiphol collection is a live-animal briefing, not a Terminal 2 hug at the belt. Do not print RTM or EIN on any paper in this file.',
    airlinesNarrative:
      'Seed carriers, read outbound, are KLM (cabin-or-cargo), Emirates (cargo) and Etihad (cargo). From Dubai each product must be re-confirmed for UAE → the Netherlands. Inbound acceptance on a Netherlands → Dubai ticket does not transfer. KLM is the home-carrier pull into AMS, but cabin-or-cargo seed mode is not a cabin promise leaving Dubai. Emirates seed mode is cargo — do not assume hold-baggage eligibility from a screenshot. Etihad requires an explicit cabin-versus-cargo check on Dubai or Abu Dhabi to Amsterdam routings. All rows stay verificationStatus unverified with “confirm current policy” until a first-party check. This Dutch outbound page names KLM, Emirates and Etihad modes; it does not steal a sitewide airline-chooser FAQ. PetClear has no airline affiliation and publishes no partnership logos. Packages are quote-only via Get Route Checked or WhatsApp +971504782999. Confirm KLM’s live Dubai–Amsterdam pet page for this OD: cabin-or-cargo seed language is not a cabin promise leaving DXB. Emirates cargo into AMS has its own handler path. Etihad from AUH, if used, must still land as a pet product at Schiphol, not as an unmarked hold bag. This page does not cover a sitewide airline-chooser FAQ. Quote-only via Get Route Checked or WhatsApp +971504782999.',
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          'Not on this seed. Amsterdam Schiphol is the only Dutch gateway listed. Do not assume a second import airport. A road transfer after AMS is a ground choice.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Gulf-carrier seed mode on this corridor is cargo. Do not assume cabin eligibility. Confirm current policy on the [Emirates pet cargo guide](/guides/emirates-pet-cargo/) and the [pet flight options hub](/guides/pet-flight-options-dubai/). Confirm the live policy for the exact pair.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          '90 days from issuance. The pet must enter the UAE inside that window. Waiting for a later ITA or Emirates bank after issuance is a common way to burn the permit.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          '90 days from issuance. The pet must enter the UAE inside that window. Dublin’s thinner live-animal calendar makes a slipped date after issuance especially costly.',
      },
      {
  ...
  },
  {
    ...
    airportsNarrative:
      'Irish arrival seed airports are Dublin (DUB) and Cork (ORK). DUB is the working long-haul live-animal arrival on the island — the airport most Aer Lingus and Emirates products can name. ORK is the Munster collection fantasy unless the carrier and the Irish veterinary border both accept live animals there. Shannon is not in the seed; do not assume it. Island geography means most families can collect from Dublin and continue by road to Cork, Galway or Belfast-bound connections; that convenience is not a second import airport. UAE departure toward Ireland: a DXB passenger ticket often still ships the animal as cargo or hold depending on the Aer Lingus or Emirates product. DWC leaving for Italy is a cargo origin aimed at FCO or MXP, not Linate. Abu Dhabi (AUH) is the Etihad alternate; Etihad is not on the Ireland seed list, so do not assume an AUH–DUB default. Airport presence in the seed is not automatic acceptance. Write DUB on the EU certificate unless ORK is truly confirmed. Leaving the UAE, DXB passenger tickets still often move the animal as cargo; DWC is the SkyCargo-style alternative. Do not assume an Etihad AUH–DUB default on an Ireland seed that does not list Etihad. Dublin live-animal collection is a cargo briefing. Cork remains a confirmation problem. Shannon is still not in the seed.',
    airlinesNarrative:
      'Seed carriers, read outbound, are Aer Lingus (cabin-or-cargo), Emirates (cargo) and Ryanair (generally not). From Dubai each product must be re-confirmed for UAE → Ireland. Aer Lingus is the home-carrier pull into DUB, but cabin-or-cargo seed mode is not a cabin promise leaving Dubai. Emirates seed mode is cargo — do not assume hold-baggage eligibility. Ryanair remains generally not pets and should not appear in a plan as the crate carrier, inbound or outbound. All rows stay unverified with “confirm current policy” until a first-party check. This Irish outbound page names Aer Lingus, Emirates and Ryanair modes; it does not steal a sitewide airline-chooser FAQ. PetClear has no airline affiliation and publishes no partnership logos. Packages are quote-only via Get Route Checked or WhatsApp +971504782999. Confirm Aer Lingus’s live Dubai–Dublin pet page for this OD: cabin-or-cargo seed language is not a cabin promise leaving DXB. Emirates cargo into DUB has its own handler path and a thinner weekday bank than CDG or MAD. Ryanair is not a planning carrier in either direction. This page does not cover a sitewide airline-chooser FAQ. Quote-only via Get Route Checked or WhatsApp +971504782999.',
    faqs: [
      {
